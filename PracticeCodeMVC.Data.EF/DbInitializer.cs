...
using PracticeCodeMVC.Utilities.Constants;
using System;
    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (_context.advertisementPages.Count() == 0)
            {
                ...
                {
                    new AdvertisementPage() {Id="home", Name="Trang chủ",AdvertistmentPositions = new List<AdvertisementPosition>(){
                        new AdvertisementPosition(){Id="home-left",Name="Bên trái"}
                    } },
                    new AdvertisementPage() {Id="product-cate", Name="Danh mục sản phẩm" ,
                        AdvertistmentPositions = new List<AdvertisementPosition>(){
